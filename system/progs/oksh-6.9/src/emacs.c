...
static int x_beg_hist(int c) { (void)c; x_load_hist(history); return KSTD;}

static int x_end_hist(int c) { (void)c; x_load_hist(histptr); return KSTD;}

static int x_prev_com(int c) { (void)c; x_load_hist(x_histp - x_arg); return KSTD;}

static int x_next_com(int c) { (void)c; x_load_hist(x_histp + x_arg); return KSTD;}
