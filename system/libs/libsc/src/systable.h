...
SYSCALL2R(0x26, intptr_t, _sc_mem_avail,  intptr_t, ssize_t)
SYSCALL3R(0x27, int,      _sc_mem_anon,   uintptr_t, ssize_t, int)
SYSCALL5R(0x28, ssize_t,  _sc_wait,       int, pid_t, int, _sc_wait_t *, ssize_t)
