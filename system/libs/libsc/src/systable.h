...
SYSCALL2V(0x80, void,     _sc_sig_entry,   uintptr_t, uintptr_t)
SYSCALL2R(0x81, int64_t,  _sc_sig_mask,    int, int64_t)
SYSCALL2R(0x82, ssize_t,  _sc_sig_info,    _sc_sig_info_t *, ssize_t)
SYSCALL0N(0x83, void,     _sc_sig_return   )
SYSCALL3R(0x84, int,      _sc_sig_send,    int, int, int)
